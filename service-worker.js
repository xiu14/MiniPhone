...
const CACHE_NAME = 'miniphone-v61';
const ASSETS_TO_CACHE = [
    ...
    './css/apps/chat.css?v=61',
    './css/apps/character.css?v=61',
    './css/apps/moments.css?v=61',
    './css/apps/voicecall.css?v=61',
    './js/main.js',
    './js/core/storage.js',
    './js/core/router.js',
    './js/core/utils.js',
