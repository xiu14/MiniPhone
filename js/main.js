...
import { loadFromLocalStorage } from './core/storage.js?v=34';
import { showScreen, switchToCharHomeScreen, switchToMyPhone } from './core/router.js?v=34';
import { handleAvatarUpload } from './core/utils.js?v=34';
import { initSettings, openGlobalPromptSettings } from './apps/settings.js?v=34';
import {
