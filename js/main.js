...
import { loadFromLocalStorage } from './core/storage.js?v=36';
import { showScreen, switchToCharHomeScreen, switchToMyPhone } from './core/router.js?v=36';
import { handleAvatarUpload } from './core/utils.js?v=36';
import { initSettings, openGlobalPromptSettings } from './apps/settings.js?v=36';
import {
