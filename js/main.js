...
import { loadFromLocalStorage } from './core/storage.js?v=32';
import { showScreen, switchToCharHomeScreen, switchToMyPhone } from './core/router.js?v=32';
import { handleAvatarUpload } from './core/utils.js?v=32';
import { initSettings, openGlobalPromptSettings } from './apps/settings.js?v=32';
import {
