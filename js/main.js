...
import { loadFromLocalStorage } from './core/storage.js?v=33';
import { showScreen, switchToCharHomeScreen, switchToMyPhone } from './core/router.js?v=33';
import { handleAvatarUpload } from './core/utils.js?v=33';
import { initSettings, openGlobalPromptSettings } from './apps/settings.js?v=33';
import {
