...
import { loadFromLocalStorage } from './core/storage.js?v=35';
import { showScreen, switchToCharHomeScreen, switchToMyPhone } from './core/router.js?v=35';
import { handleAvatarUpload } from './core/utils.js?v=35';
import { initSettings, openGlobalPromptSettings } from './apps/settings.js?v=35';
import {
